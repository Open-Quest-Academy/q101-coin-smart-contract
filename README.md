...
2. **Configure Airdrop Parameters**:
   ```solidity
   // Shareholder: 36 months, 10% immediate, 0% cliff
   shareholderVesting.configureAirdrop(
       startTime,      // Unix timestamp
       36,             // vestingMonths
       1000,           // immediateReleaseRatio (10%)
       0,              // cliffMonths
       0,              // cliffReleaseRatio
       30 days,        // minWithdrawInterval
       100 * 10**18,   // minWithdrawAmount
       0               // vestingFrequency (PER_SECOND)
   );

   // Team: 48 months, 5% immediate, 0% cliff
